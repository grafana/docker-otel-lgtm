...
![Components included in the Docker image: OpenTelemetry Collector, Prometheus, Tempo, Loki, Grafana, Pyroscope, and OBI (optional)](img/overview.png) <!-- editorconfig-checker-disable-line -->
